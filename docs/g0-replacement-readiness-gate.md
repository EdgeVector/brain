...
| `gbrain delete <slug>` | Tom | `fbrain delete <slug>` | Deleted slug invisible to all read paths; slug reusable. Native LastDB Delete converges tip absence. Tombstone tag remains as a client filter. | ✅ shipped — Phase 5, native Delete current 2026-09-10 |
